        ...
        <section id="about">
            <div className={changer}>
                ...
                <div className="row">
                    ...
                    <p className="col-md-8 col-12 about p-4">Je m'appelle Dahri Fatima. J'effectue une formation professionnelle à MolenGeek d'une durée de 6 mois dans laquelle j'ai acquis les compétences nécessaires pour devenir Full Stack Developer.</p>
                    <div className="col-md-2 col-12"></div>
                </div>
            </div>
