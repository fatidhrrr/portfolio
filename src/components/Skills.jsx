...
const Skills = () => {
    ...
    return (
        <Fragment>
            <h2 id="skills" className="titre text-center">Skills</h2>
            ...
            <div className="row">
                ...
                <div className="col-md-6 col-12">
                    ...
                    <div className="progress mt-4">
                        <div className={progress1} role="progressbar" style={{ width: '90%' }} aria-valuenow="90" aria-valuemin="0" aria-valuemax="100">90%</div>
                    </div>
                    <p className="mt-3">JAVASCRIPT / REACT</p>
                    <div className="progress mt-4">
                        <div className={progress2} role="progressbar" style={{ width: '60%' }} aria-valuenow="60" aria-valuemin="0" aria-valuemax="100">60%</div>
                    </div>
